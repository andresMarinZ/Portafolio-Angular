...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_info_paginas_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/info-paginas.service */ "./src/app/services/info-paginas.service.ts");
...
let AppComponent = class AppComponent {
    constructor(_infoService, _productos) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_info_paginas_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/info-paginas.service */ "./src/app/services/info-paginas.service.ts");



let AboutComponent = class AboutComponent {
    constructor(_infoService) {
        this._infoService = _infoService;
    }
    ngOnInit() {
    }
...
let ItemComponent = class ItemComponent {
    constructor(rooter, productoService) {
        this.rooter = rooter;
    ...
    ngOnInit() {
        this.rooter.params.subscribe(parametros => {
            ...
            this.productoService.getProducto(parametros['id']).subscribe((producto) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InfoPaginasService", function() { return InfoPaginasService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let InfoPaginasService = class InfoPaginasService {
    constructor(http) {
        this.http = http;
        this.info = {};
        this.cargar = false;
    ...
    cargarEquipo() {
        this.http.get('https://angularhtml-b5b5e.firebaseio.com/equipo.json').subscribe((resp) => {
            this.equipo = resp;
            // console.log(this.equipo);
        });
    }
};
InfoPaginasService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
InfoPaginasService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let ProductosService = class ProductosService {
    ...
    cargarProductos() {
        return new Promise((resolve, reject) => {
            this.http.get("https://angularhtml-b5b5e.firebaseio.com/productos_idx.json").subscribe((resp) => {
                // console.log(resp);
                this.productos = resp;
                this.cargando = false;
                resolve();
...
module.exports = __webpack_require__(/*! C:\Users\user\Desktop\Angular\CopiandoTemplateHtml_En_Angular\template\src\main.ts */"./src/main.ts");
